...
Create Ansible Automation Platform (AAP) software repository template<br>[hello_world github template](https://github.com/ericcames/hello_world "hello_world github template")
